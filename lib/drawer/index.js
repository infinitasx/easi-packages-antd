...
const render = /* @__PURE__ */_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return vue.openBlock(), vue.createBlock(_component_a_drawer, vue.mergeProps(_ctx.$attrs, {
    ...
    default: _withId(() => [vue.renderSlot(_ctx.$slots, "default"), _ctx.$slots.footer ? (vue.openBlock(), vue.createBlock("div", _hoisted_1, [vue.renderSlot(_ctx.$slots, "footer")])) : vue.createCommentVNode("v-if", true)]),
    _: 3
