...
var script = vue.defineComponent({
  ...
  setup(props, { emit, slots }) {
    const { bodyStyle, visible } = vue.toRefs(props);
    const computedBodyStyle = vue.computed(() => {
      return slots.footer ? { ...bodyStyle.value, paddingBottom: "55px" } : vue.toRaw(bodyStyle.value);
    });
...
const _withId = /* @__PURE__ */ vue.withScopeId("data-v-5cb92078");
vue.pushScopeId("data-v-5cb92078");
const _hoisted_1 = {
  key: 0,
  class: "drawer-footer"
};
...
const render = /* @__PURE__ */ _withId((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return vue.openBlock(), vue.createBlock(_component_a_drawer, vue.mergeProps(_ctx.$attrs, {
    ...
    default: _withId(() => [
      ...
      _ctx.$slots.footer ? (vue.openBlock(), vue.createBlock("div", _hoisted_1, [
