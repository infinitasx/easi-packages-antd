...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return _ctx.showMarker ? (vue.openBlock(true), vue.createBlock(vue.Fragment, {
    key: 0
