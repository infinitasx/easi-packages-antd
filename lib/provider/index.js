...
const render$1 = /* @__PURE__ */_withId$1((_ctx, _cache, $props, $setup, $data, $options) => {
  return vue.openBlock(), vue.createBlock("div", _hoisted_1, [(vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList(_ctx.totalNumber, item => {
    ...
    return vue.openBlock(), vue.createBlock("div", {
      ...
      key: item
    }, [vue.createVNode("p", null, vue.toDisplayString(((_ctx$waterMarker = _ctx.waterMarker) === null || _ctx$waterMarker === void 0 ? void 0 : (_ctx$waterMarker$user = _ctx$waterMarker.userInfo) === null || _ctx$waterMarker$user === void 0 ? void 0 : _ctx$waterMarker$user.name) || ((_ctx$globalProvider = _ctx.globalProvider) === null || _ctx$globalProvider === void 0 ? void 0 : (_ctx$globalProvider$u = _ctx$globalProvider.userInfo) === null || _ctx$globalProvider$u === void 0 ? void 0 : _ctx$globalProvider$u.name)), 1), vue.createVNode("p", null, vue.toDisplayString(((_ctx$waterMarker2 = _ctx.waterMarker) === null || _ctx$waterMarker2 === void 0 ? void 0 : (_ctx$waterMarker2$use = _ctx$waterMarker2.userInfo) === null || _ctx$waterMarker2$use === void 0 ? void 0 : _ctx$waterMarker2$use.mobile) || ((_ctx$globalProvider2 = _ctx.globalProvider) === null || _ctx$globalProvider2 === void 0 ? void 0 : (_ctx$globalProvider2$ = _ctx$globalProvider2.userInfo) === null || _ctx$globalProvider2$ === void 0 ? void 0 : _ctx$globalProvider2$.mobile)), 1), vue.createVNode("p", null, vue.toDisplayString(_ctx.domain), 1), (_ctx$waterMarker3 = _ctx.waterMarker) !== null && _ctx$waterMarker3 !== void 0 && _ctx$waterMarker3.cityName ? (vue.openBlock(), vue.createBlock("p", _hoisted_2, vue.toDisplayString(_ctx.waterMarker.cityName), 1)) : vue.createCommentVNode("v-if", true), (_ctx$waterMarker4 = _ctx.waterMarker) !== null && _ctx$waterMarker4 !== void 0 && _ctx$waterMarker4.ip ? (vue.openBlock(), vue.createBlock("p", _hoisted_3, vue.toDisplayString(_ctx.waterMarker.ip), 1)) : vue.createCommentVNode("v-if", true), vue.createVNode("p", null, vue.toDisplayString(_ctx.timestamp), 1)]);
  }), 128))]);
});
