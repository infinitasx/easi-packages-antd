...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _vue.openBlock(), _vue.createBlock("span", {
    ...
    _vue.createVNode("span", _hoisted_1$1, _vue.toDisplayString(_ctx.userInfo.name || "\u7528\u6237\u540D"), 1)
  ]);
}
...
const _hoisted_1 = /* @__PURE__ */ _vue.createVNode("div", { class: "flex-1" }, null, -1);
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_UserAccountAction = _vue.resolveComponent("UserAccountAction");
  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [
    ...
    _hoisted_1,
    _vue.createVNode(_component_UserAccountAction, _vue.mergeProps(_ctx.$attrs, _vue.toHandlers(_ctx.$listener)), null, 16)
  ], 64);
}
