  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_drawer, _vue.mergeProps({
    ...
    default: _withId(() => {
      ...
      return [_vue.renderSlot(_ctx.$slots, "action-render"), ((_ctx$userInfo3 = _ctx.userInfo) === null || _ctx$userInfo3 === void 0 ? void 0 : (_ctx$userInfo3$device = _ctx$userInfo3.devices) === null || _ctx$userInfo3$device === void 0 ? void 0 : _ctx$userInfo3$device.length) > 0 ? (_vue.openBlock(), _vue.createBlock(_vue.Fragment, {
        ...
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.deviceTitle), 1)]),
        _: 1
        ...
        return _vue.openBlock(), _vue.createBlock("div", {
          ...
          default: _withId(() => [item.device_type === "Desktop" ? (_vue.openBlock(), _vue.createBlock(_component_DesktopOutlined, {
            key: 0
          ...
          default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(item.device_type) + " " + _vue.toDisplayString(item.ip), 1)]),
          _: 2
        }, 1024), _vue.createVNode(_component_a_typography_link, {
          class: "flex-1 truncate",
          onClick: $event => _ctx.handleCopy(item.session_id)
        }, {
          default: _withId(() => [_vue.createTextVNode(" (" + _vue.toDisplayString(item.session_id) + ") ", 1)]),
          _: 2
        }, 1032, ["onClick"])]), _vue.createVNode("p", _hoisted_3, [_vue.createVNode(_component_a_typography_text, {
          type: "secondary"
        }, {
          default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.deviceLoginTime) + " " + _vue.toDisplayString(_ctx.transformTime(item.active_at)), 1)]),
          _: 2
        }, 1024)])]);
        ...
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.styleSetting), 1)]),
        _: 1
      }), _vue.createVNode("div", _hoisted_4, [_vue.createVNode("span", _hoisted_5, [_vue.createVNode(_component_a_typography_text, null, {
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.darkSetting), 1)]),
        _: 1
        ...
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.showTabSetting), 1)]),
        _: 1
      })]), _vue.createVNode("div", null, [_vue.createVNode(_component_a_switch, {
        ...
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.fixedTabSetting), 1)]),
        _: 1
      })]), _vue.createVNode("div", null, [_vue.createVNode(_component_a_switch, {
        ...
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.more), 1)]),
        _: 1
        ...
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.backToDashBoard), 1)]),
        _: 1
        ...
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.editPassword), 1)]),
        _: 1
        ...
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.logout), 1)]),
        _: 1
      })])) : _vue.createCommentVNode("v-if", true)];
    }),
    _: 3
