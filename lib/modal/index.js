...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock(vue.Fragment, null, [vue.createCommentVNode('  <slot name="trigger" />'), vue.createVNode(_component_a_modal, vue.mergeProps({
    ...
    footer: vue.withCtx(() => [vue.renderSlot(_ctx.$slots, "footer"), !_ctx.$slots.footer && _ctx.footer ? (vue.openBlock(), vue.createBlock("div", {
      key: 0,
      class: ["footer", {
      ...
      _: 1
    }, 8, ["type", "loading", "onClick"])) : vue.createCommentVNode("v-if", true)], 2)) : vue.createCommentVNode("v-if", true)]),
    default: vue.withCtx(() => [vue.renderSlot(_ctx.$slots, "default")]),
    _: 2
  }, [!_ctx.title ? {
    name: "title",
    fn: vue.withCtx(() => [vue.renderSlot(_ctx.$slots, "title")])
