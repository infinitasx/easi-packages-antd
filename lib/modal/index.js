...
var script = vue.defineComponent({
  ...
  setup(props, { emit }) {
    const { handleOk, visible } = vue.toRefs(props);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock(vue.Fragment, null, [
    vue.createCommentVNode('  <slot name="trigger" />'),
    vue.createVNode(_component_a_modal, vue.mergeProps({
      ...
      footer: vue.withCtx(() => [
        ...
        !_ctx.$slots.footer && _ctx.footer ? (vue.openBlock(), vue.createBlock("div", _hoisted_1, [
          _ctx.showCancel ? (vue.openBlock(), vue.createBlock(_component_a_button, {
            key: 0,
            onClick: _ctx.onCancel
          }, {
            default: vue.withCtx(() => [
              vue.createTextVNode(vue.toDisplayString(_ctx.cancelText || _ctx.getText("cancel")), 1)
            ]),
            _: 1
          }, 8, ["onClick"])) : vue.createCommentVNode("v-if", true),
          _ctx.showOk ? (vue.openBlock(), vue.createBlock(_component_a_button, {
            key: 1,
            type: _ctx.okType,
            ...
            default: vue.withCtx(() => [
              vue.createTextVNode(vue.toDisplayString(_ctx.okText || _ctx.getText("confirm")), 1)
            ]),
            _: 1
          }, 8, ["type", "loading", "onClick"])) : vue.createCommentVNode("v-if", true)
