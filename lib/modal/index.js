...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [vue.createCommentVNode('  <slot name="trigger" />'), vue.createVNode(_component_a_modal, vue.mergeProps({
    ...
    footer: vue.withCtx(() => [vue.renderSlot(_ctx.$slots, "footer"), !_ctx.$slots.footer && _ctx.footer ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [_ctx.showCancel ? (vue.openBlock(), vue.createBlock(_component_a_button, {
      key: 0,
