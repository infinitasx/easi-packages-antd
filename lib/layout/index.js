...
const _hoisted_1$4 = {
  key: 0,
  class: "easi-packages-admin-title text-white ml-16 truncate"
};
const _hoisted_2$3 = {
  key: 1,
  ...
  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [_vue.createVNode("div", {
    ...
    default: _vue.withCtx(() => [(_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(_ctx.nav, item => {
      return _vue.openBlock(), _vue.createBlock(_vue.Fragment, {
        ...
        default: _vue.withCtx(() => [(_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(item.children, child => {
          return _vue.openBlock(), _vue.createBlock(_vue.Fragment, {
            key: child.name
            ...
            default: _vue.withCtx(() => [!!child.meta.icon ? (_vue.openBlock(), _vue.createBlock("i", {
              key: 0,
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_tabs, {
    ...
    tabBarExtraContent: _vue.withCtx(() => [_vue.createVNode(_component_a_dropdown, {
      onClick: _ctx.action
    }, {
      overlay: _vue.withCtx(() => [_vue.createVNode(_component_a_menu, {
        onClick: _ctx.action
      }, {
        default: _vue.withCtx(() => [_vue.createVNode(_component_a_menu_item, {
          key: "closeAll"
        }, {
          default: _vue.withCtx(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("closeOther")), 1)]),
          _: 1
        }), _vue.createVNode(_component_a_menu_item, {
          key: "refresh"
        }, {
          default: _vue.withCtx(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("refreshPage")), 1)]),
          _: 1
        })]),
        _: 1
      }, 8, ["onClick"])]),
      default: _vue.withCtx(() => [_vue.createVNode("a", {
    ...
    default: _vue.withCtx(() => [(_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(_ctx.panes, (pane, index) => {
      return _vue.openBlock(), _vue.createBlock(_component_a_tab_pane, {
        key: pane.fullPath,
        closable: false
      }, {
        tab: _vue.withCtx(() => [_vue.createVNode("span", _hoisted_1$1, [_vue.createTextVNode(_vue.toDisplayString(pane.title) + " ", 1), _vue.withDirectives(_vue.createVNode(_component_ReloadOutlined, {
...
var script = _vue.defineComponent({
  ...
  setup(props, {
    ...
    return {
      ...
      setProvider(mode) {
        setProvider({ ..._vue.toRaw(globalProvider),
          mode
        });
      },
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_layout, {
    ...
    default: _vue.withCtx(() => [_vue.createCommentVNode(" \u4FA7\u8FB9\u680F\u5BFC\u822A  "), _vue.createVNode(_component_PageNav, {
      collapsed: _ctx.collapsed,
      ...
      default: _vue.withCtx(() => [_hoisted_1, _vue.createVNode(_component_a_layout_header, {
        class: ["easi-packages-page-header fixed top-0 right-0 bg-white flex items-center h-48 leading-48 pl-16 pr-16 z-10", {
          "easi-packages-transition-width": !_ctx.isH5
        }],
        style: {
          width: _ctx.isH5 ? "100%" : `calc(100% - ${_ctx.collWidth})`
        }
      }, {
        default: _vue.withCtx(() => [_vue.createVNode(_component_PageHeader, {
          collapsed: _ctx.collapsed,
        ...
        key: 0,
        class: ["page-tab pt-6 bg-white", [_ctx.globalProvider.fixedTab ? "fixed top-48 right-0 z-10" : "", !_ctx.isH5 && _ctx.addTransition ? "easi-packages-transition-width" : ""]],
        style: {
        ...
        default: _vue.withCtx(() => [_vue.createVNode(_component_router_view, null, {
          default: _vue.withCtx(({
            Component
            ...
            default: _vue.withCtx(() => [(_vue.openBlock(), _vue.createBlock(_vue.KeepAlive, {
        ...
        default: _vue.withCtx(() => [_vue.createTextVNode(" \xA9 " + _vue.toDisplayString(_ctx.copyRightYear()) + " EASI, Make Life Easier. ", 1)]),
        _: 1
      })]),
      _: 1
      ...
      "action-render": _vue.withCtx(() => [_vue.renderSlot(_ctx.$slots, "action-render")]),
      _: 3
