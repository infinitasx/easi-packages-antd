  ...
  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [
    _vue.createVNode("div", {
      ...
      _ctx.title || _ctx.subTitle ? _vue.withDirectives((_vue.openBlock(), _vue.createBlock("div", _hoisted_1$4, [
        ...
        _ctx.subTitle ? (_vue.openBlock(), _vue.createBlock("p", _hoisted_2$3, _vue.toDisplayString(_ctx.subTitle), 1)) : _vue.createCommentVNode("v-if", true)
      ], 512)), [
...
const render$3 = /* @__PURE__ */ _withId$2((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [
    ...
    _vue.createVNode("span", {
      ...
      _vue.createVNode("span", _hoisted_2$2, _vue.toDisplayString(_ctx.userInfo?.name || "\u7528\u6237\u540D"), 1)
    ])
  ], 64);
});
