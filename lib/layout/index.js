...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _vue.openBlock(), _vue.createElementBlock(_vue.Fragment, null, [_vue.createElementVNode("div", {
    class: _vue.normalizeClass(["py-6 flex items-center", [_ctx.collapsed ? "px-24" : "px-16"]])
  }, [_vue.createElementVNode("img", {
    src: _ctx.logo,
    alt: "",
    class: "logo"
  }, null, 8, _hoisted_1$4), _ctx.title || _ctx.subTitle ? _vue.withDirectives((_vue.openBlock(), _vue.createElementBlock("div", _hoisted_2$2, [_ctx.title ? (_vue.openBlock(), _vue.createElementBlock("p", {
    key: 0,
    class: _vue.normalizeClass(["truncate", [_ctx.subTitle ? "text-14" : "text-16"]])
  }, _vue.toDisplayString(_ctx.title), 3)) : _vue.createCommentVNode("v-if", true), _ctx.subTitle ? (_vue.openBlock(), _vue.createElementBlock("p", _hoisted_3$1, _vue.toDisplayString(_ctx.subTitle), 1)) : _vue.createCommentVNode("v-if", true)], 512)), [[_vue.vShow, !_ctx.collapsed]]) : _vue.createCommentVNode("v-if", true)], 2), _vue.createElementVNode("div", _hoisted_4$1, [_vue.createVNode(_component_a_menu, {
    class: "layout-menu",
    mode: "inline",
    ...
    default: _vue.withCtx(() => [(_vue.openBlock(true), _vue.createElementBlock(_vue.Fragment, null, _vue.renderList(_ctx.nav, item => {
      return _vue.openBlock(), _vue.createElementBlock(_vue.Fragment, {
        ...
        title: _vue.withCtx(() => [_vue.createElementVNode("span", _hoisted_5$1, [!!item.meta.icon ? (_vue.openBlock(), _vue.createElementBlock("i", {
          key: 0,
          class: _vue.normalizeClass([item.meta.icon, "anticon"])
        }, null, 2)) : _vue.createCommentVNode("v-if", true), _vue.createElementVNode("span", null, _vue.toDisplayString(item.meta.title), 1)])]),
        default: _vue.withCtx(() => [(_vue.openBlock(true), _vue.createElementBlock(_vue.Fragment, null, _vue.renderList(item.children, child => {
          return _vue.openBlock(), _vue.createElementBlock(_vue.Fragment, {
            key: child.name
            ...
            default: _vue.withCtx(() => [!!child.meta.icon ? (_vue.openBlock(), _vue.createElementBlock("i", {
              key: 0,
              class: _vue.normalizeClass([child.meta.icon, "anticon"])
            }, null, 2)) : _vue.createCommentVNode("v-if", true), _vue.createElementVNode("span", null, _vue.toDisplayString(child.meta.title), 1)]),
            _: 2
        ...
        default: _vue.withCtx(() => [!!item.meta.icon ? (_vue.openBlock(), _vue.createElementBlock("i", {
          key: 0,
          class: _vue.normalizeClass([item.meta.icon, "anticon"])
        }, null, 2)) : _vue.createCommentVNode("v-if", true), _vue.createElementVNode("span", null, _vue.toDisplayString(item.meta.title), 1)]),
        _: 2
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _vue.openBlock(), _vue.createElementBlock(_vue.Fragment, null, [_vue.withDirectives(_vue.createElementVNode("div", {
    class: _vue.normalizeClass(["side-placeholder", {
...
function generate(node, key, rootProps) {
  if (!rootProps) {
    return _vue.h(node.tag, _objectSpread$e({
      key: key
...
const _hoisted_1$3 = /* @__PURE__ */_vue.createElementVNode("div", {
  class: "flex-1"
}, null, -1);
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _vue.openBlock(), _vue.createElementBlock(_vue.Fragment, null, [_vue.withDirectives(_vue.createVNode(_component_MenuFoldOutlined, {
    class: "text-18",
    ...
    class: "text-18",
    onClick: _ctx.colToggle
  }, null, 8, ["onClick"]), [[_vue.vShow, _ctx.collapsed]]), _hoisted_1$3, _vue.createElementVNode("span", {
  ...
  }, null, 8, ["src"])) : _vue.createCommentVNode("v-if", true), _vue.createElementVNode("span", null, _vue.toDisplayString(((_ctx$userInfo2 = _ctx.userInfo) === null || _ctx$userInfo2 === void 0 ? void 0 : _ctx$userInfo2.name) || "\u7528\u6237\u540D"), 1)])], 64);
}
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_drawer, _vue.mergeProps({
    ...
    title: _vue.withCtx(() => {
      ...
      return [_vue.createElementVNode("header", _hoisted_1$2, [(_ctx$userInfo = _ctx.userInfo) !== null && _ctx$userInfo !== void 0 && _ctx$userInfo.avatar ? (_vue.openBlock(), _vue.createBlock(_component_a_avatar, {
        key: 0,
        shape: "circle",
        size: "default",
        src: _ctx.userInfo.avatar,
    ...
    default: _vue.withCtx(() => {
      ...
      return [_vue.renderSlot(_ctx.$slots, "action-render"), ((_ctx$userInfo3 = _ctx.userInfo) === null || _ctx$userInfo3 === void 0 ? void 0 : (_ctx$userInfo3$device = _ctx$userInfo3.devices) === null || _ctx$userInfo3$device === void 0 ? void 0 : _ctx$userInfo3$device.length) > 0 ? (_vue.openBlock(), _vue.createElementBlock(_vue.Fragment, {
        key: 0
        ...
        _: 1
      }), (_vue.openBlock(true), _vue.createElementBlock(_vue.Fragment, null, _vue.renderList(_ctx.userInfo.devices, item => {
        return _vue.openBlock(), _vue.createElementBlock("div", {
          class: "mb-32",
          key: item.id
        }, [_vue.createElementVNode("p", _hoisted_2$1, [_vue.createVNode(_component_a_typography_text, {
          type: "secondary"
        }, {
          ...
          _: 2
        }, 1032, ["onClick"])]), _vue.createElementVNode("p", _hoisted_3, [_vue.createVNode(_component_a_typography_text, {
          type: "secondary"
        }, {
        ...
        _: 1
      }), _vue.createElementVNode("div", _hoisted_4, [_vue.createElementVNode("span", _hoisted_5, [_vue.createVNode(_component_a_typography_text, null, {
        default: _vue.withCtx(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.darkSetting), 1)]),
        _: 1
      })]), _vue.createElementVNode("div", null, [_vue.createVNode(_component_a_switch, {
        checked: _ctx.globalProvider.mode,
        onChange: _cache[0] || (_cache[0] = $event => _ctx.setSetting("mode", $event))
      }, null, 8, ["checked"])])]), _ctx.showTabSetting ? (_vue.openBlock(), _vue.createElementBlock("div", _hoisted_6, [_vue.createElementVNode("span", _hoisted_7, [_vue.createVNode(_component_a_typography_text, null, {
      ...
      }, null, 8, ["checked"])])])) : _vue.createCommentVNode("v-if", true), _ctx.showTabSetting ? (_vue.openBlock(), _vue.createElementBlock("div", _hoisted_8, [_vue.createElementVNode("span", _hoisted_9, [_vue.createVNode(_component_a_typography_text, null, {
        ...
        _: 1
      })) : _vue.createCommentVNode("v-if", true), !!_ctx.toDashboard ? (_vue.openBlock(), _vue.createElementBlock("div", {
        key: 4,
        ...
        _: 1
      })])) : _vue.createCommentVNode("v-if", true), !!_ctx.editPassword ? (_vue.openBlock(), _vue.createElementBlock("div", {
        key: 5,
        class: "more-item flex items-center cursor-pointer easi-hover-block",
        ...
        _: 1
      })])) : _vue.createCommentVNode("v-if", true), !!_ctx.onLogout ? (_vue.openBlock(), _vue.createElementBlock("div", {
        key: 6,
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_tabs, {
    ...
    tabBarExtraContent: _vue.withCtx(() => [_vue.createVNode(_component_a_dropdown, {
      ...
      default: _vue.withCtx(() => [_vue.createElementVNode("a", {
        class: "ant-dropdown-link p-12 mr-8",
        onClick: _cache[0] || (_cache[0] = _vue.withModifiers(() => {}, ["prevent"]))
      }, [_vue.createVNode(_component_MoreOutlined, {
        class: "text-16 leading-0"
      })])]),
      _: 1
    }, 8, ["onClick"])]),
    default: _vue.withCtx(() => [(_vue.openBlock(true), _vue.createElementBlock(_vue.Fragment, null, _vue.renderList(_ctx.panes, (pane, index) => {
      return _vue.openBlock(), _vue.createBlock(_component_a_tab_pane, {
        key: pane.fullPath,
        closable: false
      }, {
        tab: _vue.withCtx(() => [_vue.createElementVNode("span", _hoisted_1$1, [_vue.createTextVNode(_vue.toDisplayString(pane.title) + " ", 1), _vue.withDirectives(_vue.createVNode(_component_ReloadOutlined, {
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_layout, {
    ...
    default: _vue.withCtx(() => [_vue.createCommentVNode(" \u4FA7\u8FB9\u680F\u5BFC\u822A  "), _vue.createVNode(_component_PageNav, {
      ...
      default: _vue.withCtx(() => [_hoisted_1, _vue.createVNode(_component_a_layout_header, {
        class: _vue.normalizeClass(["page-header fixed top-0 right-0 bg-white flex items-center h-48 leading-48 pl-16 pr-16 z-10", {
          "transition-width": !_ctx.isH5
        }]),
        style: _vue.normalizeStyle({
        ...
        key: 0,
        class: _vue.normalizeClass(["page-tab pt-6 bg-white", [_ctx.globalProvider.fixedTab ? "fixed top-48 right-0 z-10" : "", !_ctx.isH5 && _ctx.addTransition ? "transition-width" : ""]]),
        style: _vue.normalizeStyle({
          width: _ctx.globalProvider.fixedTab && !_ctx.isH5 ? `calc(100% - ${_ctx.collWidth})` : `100%`
        }),
        onReloadPage: _ctx.onReloadPage
      }, null, 8, ["class", "style", "onReloadPage"])) : _vue.createCommentVNode("v-if", true), _ctx.globalProvider.showTab && _ctx.globalProvider.fixedTab ? (_vue.openBlock(), _vue.createElementBlock("div", _hoisted_2)) : _vue.createCommentVNode("v-if", true), _vue.createVNode(_component_a_layout_content, null, {
