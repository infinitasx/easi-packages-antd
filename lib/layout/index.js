...
const _withId$3 = /* @__PURE__ */ _vue.withScopeId("data-v-ab3d12e0");
...
const render$5 = /* @__PURE__ */ _withId$3((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [
    _vue.createVNode("div", {
      class: ["py-10 flex items-center", [_ctx.collapsed ? "px-24" : "px-16"]]
    }, [
...
const _withId$2 = /* @__PURE__ */ _vue.withScopeId("data-v-6637da7e");
...
const _hoisted_8 = /* @__PURE__ */ _vue.createVNode("div", null, "\u56DE\u5230Dashboard", -1);
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  const _component_RollbackOutlined = _vue.resolveComponent("RollbackOutlined");
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_drawer, _vue.mergeProps({
    ...
    default: _vue.withCtx(() => [
      ...
      !!_ctx.toDashboard ? (_vue.openBlock(), _vue.createBlock("div", {
        key: 0,
        class: "more-item flex items-center mb-32 cursor-pointer gray",
        onClick: _cache[4] || (_cache[4] = (...args) => _ctx.toDashBoard && _ctx.toDashBoard(...args))
      }, [
        _vue.createVNode(_component_RollbackOutlined, { class: "mr-8 text-14" }),
        _hoisted_8
      ])) : _vue.createCommentVNode("v-if", true),
      _vue.createVNode("div", {
