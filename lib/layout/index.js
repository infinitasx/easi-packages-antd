...
function generate(node, key, rootProps) {
  if (!rootProps) {
    return _vue.h(node.tag, _objectSpread$a({
      key: key
...
var Icon = function Icon(props, context) {
  ...
  var classObj = (_classObj = {
    anticon: true
  }, _defineProperty$8(_classObj, "anticon-".concat(icon.name), Boolean(icon.name)), _defineProperty$8(_classObj, cls, cls), _classObj);
...
const _withId$2 = /* @__PURE__ */ _vue.withScopeId("data-v-1586402f");
_vue.pushScopeId("data-v-1586402f");
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_drawer, _vue.mergeProps({
    ...
    default: _withId$2(() => [
      ...
      _vue.createVNode(_component_a_typography_text, { class: "block mb-32" }, {
        default: _withId$2(() => [
          _vue.createTextVNode(_vue.toDisplayString(_ctx.getEASIText("styleSetting")), 1)
        ]),
        _: 1
      }),
      _vue.createVNode("div", _hoisted_2$1, [
        _vue.createVNode("span", _hoisted_3$1, [
          _vue.createVNode(_component_a_typography_text, { type: "secondary" }, {
            default: _withId$2(() => [
              _vue.createTextVNode(_vue.toDisplayString(_ctx.getEASIText("darkSetting")), 1)
            ]),
            _: 1
          })
        ]),
      ...
      _vue.createVNode("div", _hoisted_4, [
        _vue.createVNode("span", _hoisted_5, [
          _vue.createVNode(_component_a_typography_text, { type: "secondary" }, {
            default: _withId$2(() => [
              _vue.createTextVNode(_vue.toDisplayString(_ctx.getEASIText("showTabSetting")), 1)
            ]),
            _: 1
          })
        ]),
      ...
      _vue.createVNode("div", _hoisted_6, [
        _vue.createVNode("span", _hoisted_7, [
          _vue.createVNode(_component_a_typography_text, { type: "secondary" }, {
            default: _withId$2(() => [
              _vue.createTextVNode(_vue.toDisplayString(_ctx.getEASIText("fixedTabSetting")), 1)
            ]),
            _: 1
          })
        ]),
      ...
      _vue.createVNode(_component_a_typography_text, { class: "block mb-32" }, {
        default: _withId$2(() => [
          _vue.createTextVNode(_vue.toDisplayString(_ctx.getEASIText("more")), 1)
        ]),
        _: 1
      }),
      !!_ctx.toDashboard ? (_vue.openBlock(), _vue.createBlock("div", {
        key: 0,
        class: "more-item flex items-center mb-32 cursor-pointer easi-hover-block",
        onClick: _cache[4] || (_cache[4] = (...args) => _ctx.toDashBoard && _ctx.toDashBoard(...args))
      }, [
        _vue.createVNode(_component_CompassOutlined, { class: "mr-8 text-14" }),
        _vue.createVNode("div", null, _vue.toDisplayString(_ctx.getEASIText("backToDashBoard")), 1)
      ])) : _vue.createCommentVNode("v-if", true),
      _vue.createVNode("div", {
        class: "more-item flex items-center mb-32 cursor-pointer text-red-400 easi-hover-block",
        ...
        _vue.createVNode("div", null, _vue.toDisplayString(_ctx.getEASIText("logout")), 1)
      ])
    ]),
    _: 3
  }, 16);
...
script$2.__scopeId = "data-v-1586402f";
script$2.__file = "packages/layout/setting.vue";
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_layout, { class: "min-h-screen" }, {
    default: _withId(() => [
      ...
      _vue.createVNode(_component_PageSetting, {
        ...
        _: 3
      }, 8, ["visible", "userInfo", "onLogout", "toDashboard"])
    ]),
    _: 1
  });
});
