...
const render$2 = /* @__PURE__ */_withId$2((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_drawer, _vue.mergeProps({
    ...
    title: _withId$2(() => {
      ...
      return [_vue.createVNode("header", _hoisted_1$2, [(_ctx$userInfo = _ctx.userInfo) !== null && _ctx$userInfo !== void 0 && _ctx$userInfo.avatar ? (_vue.openBlock(), _vue.createBlock(_component_a_avatar, {
        key: 0,
        shape: "circle",
        size: "default",
        src: _ctx.userInfo.avatar,
