...
const render$5 = /* @__PURE__ */_withId$4((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [_vue.createVNode("div", {
  ...
  }, _vue.toDisplayString(_ctx.title), 3)) : _vue.createCommentVNode("v-if", true), _ctx.subTitle ? (_vue.openBlock(), _vue.createBlock("p", _hoisted_2$2, _vue.toDisplayString(_ctx.subTitle), 1)) : _vue.createCommentVNode("v-if", true)], 512)), [[_vue.vShow, !_ctx.collapsed]]) : _vue.createCommentVNode("v-if", true)], 2), _vue.createVNode("div", _hoisted_3$1, [_vue.createVNode(_component_a_menu, {
    class: "layout-menu",
    mode: "inline",
    ...
    default: _withId$4(() => [(_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(_ctx.nav, item => {
      return _vue.openBlock(), _vue.createBlock(_vue.Fragment, {
        ...
        title: _withId$4(() => [_vue.createVNode("span", _hoisted_4$1, [!!item.meta.icon ? (_vue.openBlock(), _vue.createBlock("i", {
          key: 0,
        ...
        default: _withId$4(() => [(_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(item.children, child => {
          return _vue.openBlock(), _vue.createBlock(_vue.Fragment, {
            key: child.name
            ...
            default: _withId$4(() => [!!child.meta.icon ? (_vue.openBlock(), _vue.createBlock("i", {
              key: 0,
        ...
        default: _withId$4(() => [!!item.meta.icon ? (_vue.openBlock(), _vue.createBlock("i", {
          key: 0,
          class: [item.meta.icon, "anticon"]
        }, null, 2)) : _vue.createCommentVNode("v-if", true), _vue.createVNode("span", null, _vue.toDisplayString(item.meta.title), 1)]),
        _: 2
...
const render$3 = /* @__PURE__ */_withId$3((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [_vue.withDirectives(_vue.createVNode(_component_MenuFoldOutlined, {
    ...
    class: "text-18",
    onClick: _ctx.colToggle
  }, null, 8, ["onClick"]), [[_vue.vShow, _ctx.collapsed]]), _hoisted_1$3, _vue.createVNode("span", {
