...
var script$5 = _vue.defineComponent({
  ...
  setup(props) {
    const { collapsed } = _vue.toRefs(props);
...
const _withId$4 = /* @__PURE__ */ _vue.withScopeId("data-v-a3884aa0");
...
const _hoisted_3$1 = { class: "flex-1 overflow-y-auto overflow-x-hidden" };
...
const render$5 = /* @__PURE__ */ _withId$4((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [
    _vue.createVNode("div", {
      ...
      _ctx.title || _ctx.subTitle ? _vue.withDirectives((_vue.openBlock(), _vue.createBlock("div", _hoisted_1$4, [
        _ctx.title ? (_vue.openBlock(), _vue.createBlock("p", {
          key: 0,
          class: ["truncate", [_ctx.subTitle ? "text-14" : "text-16"]]
        }, _vue.toDisplayString(_ctx.title), 3)) : _vue.createCommentVNode("v-if", true),
        _ctx.subTitle ? (_vue.openBlock(), _vue.createBlock("p", _hoisted_2$2, _vue.toDisplayString(_ctx.subTitle), 1)) : _vue.createCommentVNode("v-if", true)
      ], 512)), [
        [_vue.vShow, !_ctx.collapsed]
      ]) : _vue.createCommentVNode("v-if", true)
    ], 2),
    _vue.createVNode("div", _hoisted_3$1, [
      _vue.createVNode(_component_a_menu, {
        class: "layout-menu",
        mode: "inline",
        ...
        default: _withId$4(() => [
          (_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(_ctx.nav, (item) => {
            return _vue.openBlock(), _vue.createBlock(_vue.Fragment, {
              ...
              item.children && item.children.length > 0 && !item.meta.hideMenu ? (_vue.openBlock(), _vue.createBlock(_component_a_sub_menu, {
                ...
                title: _withId$4(() => [
                  _vue.createVNode("span", _hoisted_4$1, [
                    !!item.meta.icon ? (_vue.openBlock(), _vue.createBlock("i", {
                      key: 0,
                      class: [item.meta.icon, "anticon"]
                    }, null, 2)) : _vue.createCommentVNode("v-if", true),
                    _vue.createVNode("span", null, _vue.toDisplayString(item.meta.title), 1)
                  ])
                ]),
                default: _withId$4(() => [
                  (_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(item.children, (child) => {
                    return _vue.openBlock(), _vue.createBlock(_vue.Fragment, {
                      key: child.name
                    }, [
                      !child.meta.hideMenu ? (_vue.openBlock(), _vue.createBlock(_component_a_menu_item, {
                        ...
                        default: _withId$4(() => [
                          !!child.meta.icon ? (_vue.openBlock(), _vue.createBlock("i", {
                            key: 0,
                            class: [child.meta.icon, "anticon"]
                          }, null, 2)) : _vue.createCommentVNode("v-if", true),
                          _vue.createVNode("span", null, _vue.toDisplayString(child.meta.title), 1)
                        ]),
                        _: 2
                      }, 1032, ["onClick"])) : _vue.createCommentVNode("v-if", true)
                    ], 64);
                  }), 128))
                ]),
                _: 2
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [
    _vue.withDirectives(_vue.createVNode("div", {
      ...
      [_vue.vShow, !_ctx.isH5]
    ]),
    _vue.withDirectives(_vue.createVNode(_component_a_layout_sider, {
      ...
      default: _vue.withCtx(() => [
        _vue.createVNode(_component_NavMenu, {
          logo: _ctx.logo,
          title: _ctx.title,
    ...
    _vue.createVNode(_component_a_drawer, {
      placement: "left",
      width: "200px",
      closable: false,
      ...
      default: _vue.withCtx(() => [
        _vue.createVNode(_component_a_layout_sider, {
...
const _withId$3 = /* @__PURE__ */ _vue.withScopeId("data-v-45ec92c4");
_vue.pushScopeId("data-v-45ec92c4");
const _hoisted_1$3 = /* @__PURE__ */ _vue.createVNode("div", { class: "flex-1" }, null, -1);
_vue.popScopeId();
const render$3 = /* @__PURE__ */ _withId$3((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [
    _vue.withDirectives(_vue.createVNode(_component_MenuFoldOutlined, {
      class: "text-18",
      onClick: _ctx.colToggle
    }, null, 8, ["onClick"]), [
      [_vue.vShow, !_ctx.collapsed]
    ]),
    _vue.withDirectives(_vue.createVNode(_component_MenuUnfoldOutlined, {
      class: "text-18",
      onClick: _ctx.colToggle
    }, null, 8, ["onClick"]), [
      [_vue.vShow, _ctx.collapsed]
    ...
    _vue.createVNode("span", {
      ...
      _ctx.userInfo?.avatar ? (_vue.openBlock(), _vue.createBlock(_component_a_avatar, {
        key: 0,
        class: "mr-8",
        shape: "circle",
        size: "default",
      ...
      }, null, 8, ["src"])) : _vue.createCommentVNode("v-if", true),
      _vue.createVNode("span", null, _vue.toDisplayString(_ctx.userInfo?.name || "\u7528\u6237\u540D"), 1)
    ])
  ], 64);
});
...
function setProvider(provide) {
  const { cachedPage, reloadPage, ...other } = _vue.toRaw(provide);
  ...
  setup(props) {
    ...
    return {
      ...
      handleCopy(session_id) {
        ...
        if (easiWebUtils.copy(session_id, drawer)) {
...
const render$2 = /* @__PURE__ */ _withId$2((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_drawer, _vue.mergeProps({
    ...
    title: _withId$2(() => [
      _vue.createVNode("header", _hoisted_1$2, [
        _ctx.userInfo?.avatar ? (_vue.openBlock(), _vue.createBlock(_component_a_avatar, {
          key: 0,
          shape: "circle",
          size: "default",
        ...
        _vue.createTextVNode(" " + _vue.toDisplayString(_ctx.userInfo?.name || "\u7528\u6237\u540D"), 1)
      ])
    ]),
    default: _withId$2(() => [
      _vue.renderSlot(_ctx.$slots, "action-render"),
      _ctx.userInfo?.devices?.length > 0 ? (_vue.openBlock(), _vue.createBlock(_vue.Fragment, { key: 0 }, [
        _vue.createVNode(_component_a_typography_text, {
          strong: "",
          class: "block mb-32"
        }, {
          default: _withId$2(() => [
            _vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.deviceTitle), 1)
          ]),
          _: 1
        }),
        (_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(_ctx.userInfo.devices, (item) => {
          return _vue.openBlock(), _vue.createBlock("div", {
            ...
            _vue.createVNode("p", _hoisted_2$1, [
              _vue.createVNode(_component_a_typography_text, { type: "secondary" }, {
                default: _withId$2(() => [
                  item.device_type === "Desktop" ? (_vue.openBlock(), _vue.createBlock(_component_DesktopOutlined, { key: 0 })) : item.device_type === "Mobile" ? (_vue.openBlock(), _vue.createBlock(_component_MobileOutlined, { key: 1 })) : item.device_type === "Tablet" ? (_vue.openBlock(), _vue.createBlock(_component_TabletOutlined, { key: 2 })) : _vue.createCommentVNode("v-if", true)
                ]),
                _: 2
              }, 1024),
              _vue.createVNode(_component_a_typography_text, { class: "px-8" }, {
                default: _withId$2(() => [
                  _vue.createTextVNode(_vue.toDisplayString(item.device_type) + " " + _vue.toDisplayString(item.ip), 1)
                ]),
                _: 2
              }, 1024),
              _vue.createVNode(_component_a_typography_link, {
                class: "flex-1 truncate",
                onClick: _ctx.handleCopy
              }, {
                default: _withId$2(() => [
                  _vue.createTextVNode(" (" + _vue.toDisplayString(item.session_id) + ") ", 1)
                ]),
                _: 2
              }, 1032, ["onClick"])
            ]),
            _vue.createVNode("p", _hoisted_3, [
              _vue.createVNode(_component_a_typography_text, { type: "secondary" }, {
                default: _withId$2(() => [
                  _vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.deviceLoginTime) + " " + _vue.toDisplayString(_ctx.transformTime(item.active_at)), 1)
                ]),
                _: 2
              }, 1024)
            ])
      ...
      _vue.createVNode(_component_a_typography_text, {
        ...
        default: _withId$2(() => [
          _vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.styleSetting), 1)
        ]),
        _: 1
      }),
      _vue.createVNode("div", _hoisted_4, [
        _vue.createVNode("span", _hoisted_5, [
          _vue.createVNode(_component_a_typography_text, null, {
            default: _withId$2(() => [
              _vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.darkSetting), 1)
            ]),
            _: 1
          })
        ]),
      ...
      _ctx.showTabSetting ? (_vue.openBlock(), _vue.createBlock("div", _hoisted_6, [
        _vue.createVNode("span", _hoisted_7, [
          _vue.createVNode(_component_a_typography_text, null, {
            default: _withId$2(() => [
              _vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.showTabSetting), 1)
            ]),
            _: 1
          })
        ]),
      ...
      _ctx.showTabSetting ? (_vue.openBlock(), _vue.createBlock("div", _hoisted_8, [
        _vue.createVNode("span", _hoisted_9, [
          _vue.createVNode(_component_a_typography_text, null, {
            default: _withId$2(() => [
              _vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.fixedTabSetting), 1)
            ]),
            _: 1
          })
        ]),
      ...
      _vue.createVNode(_component_a_divider),
      !!_ctx.onLogout || !!_ctx.toDashboard || !!_ctx.editPassword ? (_vue.openBlock(), _vue.createBlock(_component_a_typography_text, {
        key: 3,
        strong: "",
        class: "block margin-bottom"
      }, {
        default: _withId$2(() => [
          _vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.more), 1)
        ]),
        _: 1
      })) : _vue.createCommentVNode("v-if", true),
      !!_ctx.toDashboard ? (_vue.openBlock(), _vue.createBlock("div", {
        key: 4,
        ...
        _vue.createVNode(_component_CompassOutlined, { class: "mr-8 text-14" }),
        _vue.createVNode(_component_a_typography_text, null, {
          default: _withId$2(() => [
            _vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.backToDashBoard), 1)
          ]),
          _: 1
        })
      ])) : _vue.createCommentVNode("v-if", true),
      !!_ctx.editPassword ? (_vue.openBlock(), _vue.createBlock("div", {
        key: 5,
        class: "more-item flex items-center cursor-pointer easi-hover-block",
        onClick: _cache[5] || (_cache[5] = (...args) => _ctx.handleEditPassword && _ctx.handleEditPassword(...args))
      }, [
        _vue.createVNode(_component_UnlockOutlined, { class: "mr-8 text-14" }),
        _vue.createVNode(_component_a_typography_text, null, {
          default: _withId$2(() => [
            _vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.editPassword), 1)
          ]),
          _: 1
        })
      ])) : _vue.createCommentVNode("v-if", true),
      !!_ctx.onLogout ? (_vue.openBlock(), _vue.createBlock("div", {
        key: 6,
        ...
        _vue.createVNode(_component_a_typography_text, { type: "danger" }, {
          default: _withId$2(() => [
            _vue.createTextVNode(_vue.toDisplayString(_ctx.globalEASILocale.message.logout), 1)
          ]),
          _: 1
        })
      ])) : _vue.createCommentVNode("v-if", true)
...
const render$1 = /* @__PURE__ */ _withId$1((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_tabs, {
    ...
    tabBarExtraContent: _withId$1(() => [
      _vue.createVNode(_component_a_dropdown, { onClick: _ctx.action }, {
        overlay: _withId$1(() => [
          _vue.createVNode(_component_a_menu, { onClick: _ctx.action }, {
            default: _withId$1(() => [
              _vue.createVNode(_component_a_menu_item, { key: "closeAll" }, {
                default: _withId$1(() => [
                  _vue.createTextVNode(_vue.toDisplayString(_ctx.getText("closeOther")), 1)
                ]),
                _: 1
              }),
              _vue.createVNode(_component_a_menu_item, { key: "refresh" }, {
                default: _withId$1(() => [
                  _vue.createTextVNode(_vue.toDisplayString(_ctx.getText("refreshPage")), 1)
                ]),
                _: 1
              })
            ]),
        ...
        default: _withId$1(() => [
          _vue.createVNode("a", {
            ...
            _vue.createVNode(_component_MoreOutlined, { class: "text-16 leading-0" })
          ])
        ]),
        _: 1
      }, 8, ["onClick"])
    ...
    default: _withId$1(() => [
      (_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(_ctx.panes, (pane, index) => {
        return _vue.openBlock(), _vue.createBlock(_component_a_tab_pane, {
          key: pane.fullPath,
          closable: false
        }, {
          tab: _withId$1(() => [
            _vue.createVNode("span", _hoisted_1$1, [
              _vue.createTextVNode(_vue.toDisplayString(pane.title) + " ", 1),
              _vue.withDirectives(_vue.createVNode(_component_ReloadOutlined, {
                class: "icon-action text-12 leading-0 ml-8",
                onClick: _vue.withModifiers(_ctx.reloadPage, ["stop"])
              }, null, 8, ["onClick"]), [
                [_vue.vShow, pane.fullPath === _ctx.activeKey]
              ]),
              _vue.withDirectives(_vue.createVNode(_component_CloseOutlined, {
                class: "icon-action text-12 leading-0 ml-8",
                onClick: _vue.withModifiers(($event) => _ctx.removeTab(index), ["stop"])
              }, null, 8, ["onClick"]), [
                [_vue.vShow, _ctx.panes.length !== 1]
              ])
            ])
          ]),
          _: 2
...
const _hoisted_1 = /* @__PURE__ */ _vue.createVNode("div", { class: "h-48" }, null, -1);
const _hoisted_2 = {
  key: 1,
  class: "h-64"
};
...
const render = /* @__PURE__ */ _withId((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  return _vue.openBlock(), _vue.createBlock(_component_a_layout, { class: "min-h-screen" }, {
    default: _withId(() => [
      _vue.createCommentVNode(" \u4FA7\u8FB9\u680F\u5BFC\u822A  "),
      _vue.createVNode(_component_PageNav, {
        collapsed: _ctx.collapsed,
      ...
      _vue.createCommentVNode(" \u5185\u5BB9\u5E03\u5C40 "),
      _vue.createVNode(_component_a_layout, null, {
        default: _withId(() => [
          _hoisted_1,
          _vue.createVNode(_component_a_layout_header, {
            ...
            default: _withId(() => [
              _vue.createVNode(_component_PageHeader, {
                collapsed: _ctx.collapsed,
          ...
          _ctx.globalProvider.showTab ? (_vue.openBlock(), _vue.createBlock(_component_PageTab, {
            key: 0,
          ...
          }, null, 8, ["class", "style", "onReloadPage"])) : _vue.createCommentVNode("v-if", true),
          _ctx.globalProvider.showTab && _ctx.globalProvider.fixedTab ? (_vue.openBlock(), _vue.createBlock("div", _hoisted_2)) : _vue.createCommentVNode("v-if", true),
          _vue.createVNode(_component_a_layout_content, null, {
            default: _withId(() => [
              _vue.createVNode(_component_router_view, null, {
                default: _withId(({ Component }) => [
                  _vue.createVNode(_vue.Transition, {
                    ...
                    default: _withId(() => [
                      (_vue.openBlock(), _vue.createBlock(_vue.KeepAlive, {
          ...
          _vue.createVNode(_component_a_layout_footer, { class: "px-16 py-12 text-center" }, {
            default: _withId(() => [
              _vue.createTextVNode(" \xA9 " + _vue.toDisplayString(_ctx.copyRightYear()) + " EASI, Make Life Easier. ", 1)
            ]),
            _: 1
          })
        ]),
