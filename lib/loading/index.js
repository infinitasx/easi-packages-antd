...
}, [/* @__PURE__ */vue.createVNode("div")])], -1);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock(vue.Transition, {
    ...
    default: vue.withCtx(() => [_ctx.cShow ? (vue.openBlock(), vue.createBlock("div", _hoisted_1, [vue.createVNode("div", {
      class: ["easi-packages-loading", _ctx.cSize]
    }, [_hoisted_2, _ctx.title || _ctx.cTitle ? (vue.openBlock(), vue.createBlock("p", _hoisted_3, vue.toDisplayString(_ctx.title || _ctx.cTitle), 1)) : vue.createCommentVNode("v-if", true)], 2)])) : vue.createCommentVNode("v-if", true)]),
    _: 1
  });
}
