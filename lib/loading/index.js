...
}, [/* @__PURE__ */vue.createElementVNode("div")])], -1);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return vue.openBlock(), vue.createBlock(vue.Transition, {
    ...
    default: vue.withCtx(() => [_ctx.cShow ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [vue.createElementVNode("div", {
      class: vue.normalizeClass(["loading", _ctx.cSize])
    }, [_hoisted_2, _ctx.title || _ctx.cTitle ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_3, vue.toDisplayString(_ctx.title || _ctx.cTitle), 1)) : vue.createCommentVNode("v-if", true)], 2)])) : vue.createCommentVNode("v-if", true)]),
    _: 1
  });
}
