...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createBlock(_component_a_card, {
    ...
    default: vue.withCtx(() => [vue.createVNode(_component_a_result, {
      ...
      return {
        name,
        fn: vue.withCtx(slotProps => [vue.renderSlot(_ctx.$slots, name, vue.normalizeProps(vue.guardReactiveProps(slotProps)))])
      };
    })]), 1032, ["status"])]),
    _: 3
  });
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", null, [_ctx.$usePermissions(_ctx.$route.meta.permission) || _ctx.hasPermission ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, {
    key: 0
  }, [_ctx.showPageHeader ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1, [vue.createVNode(_component_a_page_header, {
    ...
    default: vue.withCtx(() => [_ctx.pageDesc ? (vue.openBlock(), vue.createElementBlock("p", _hoisted_2, vue.toDisplayString(_ctx.pageDesc), 1)) : vue.createCommentVNode("v-if", true), vue.renderSlot(_ctx.$slots, "header")]),
    _: 3
  }, 8, ["title"])])) : vue.createCommentVNode("v-if", true), vue.createElementVNode("div", _hoisted_3, [_ctx.layoutType === "card" ? (vue.openBlock(), vue.createBlock(_component_a_card, {
    key: 0
  }, {
    ...
    title: vue.withCtx(() => [_hoisted_4]),
    "sub-title": vue.withCtx(() => [vue.createTextVNode(vue.toDisplayString(_ctx.getText("noPermission")), 1)]),
    _: 1
  }))]);
}
