...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.withDirectives((vue.openBlock(), vue.createBlock(_component_a_table, vue.mergeProps({ scroll: _ctx.scroll }, _ctx.$attrs), vue.createSlots({ _: 2 }, [
        ...
        vue.createVNode(_component_a_row, {
          ...
          default: vue.withCtx(() => [
            vue.createVNode(_component_a_col, {
              ...
              default: vue.withCtx(() => [
                _ctx.$slots.headerLeft ? (vue.openBlock(), vue.createBlock(_component_a_space, {
                  key: 0,
                  class: "flex-wrap"
                }, {
                  default: vue.withCtx(() => [
            ...
            vue.createVNode(_component_a_col, null, {
              default: vue.withCtx(() => [
                _ctx.$slots.headerRight ? (vue.openBlock(), vue.createBlock(_component_a_space, { key: 0 }, {
                  default: vue.withCtx(() => [
    ...
    vue.renderList(_ctx.$slots, (index, name) => {
      return {
        ...
        fn: vue.withCtx((slotProps) => [
          _ctx.$slots.name !== "title" && _ctx.$slots.name !== "headerLeft" && _ctx.$slots.name !== "headerRight" ? vue.renderSlot(_ctx.$slots, name, vue.mergeProps({ key: 0 }, slotProps)) : vue.createCommentVNode("v-if", true)
        ])
      };
    })
  ]), 1040, ["scroll"])), [
