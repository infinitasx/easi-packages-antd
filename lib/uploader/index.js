...
assign(Cropper.prototype, render$6, preview, events, handlers, change, methods);

var script$5 = _vue.defineComponent({
  name: "previewContainer"
});

const _withId$5 = /* @__PURE__ */_vue.withScopeId("data-v-0a563ea6");

_vue.pushScopeId("data-v-0a563ea6");
...
const render$5 = /* @__PURE__ */_withId$5((_ctx, _cache, $props, $setup, $data, $options) => {
  const _component_a_image_preview_group = _vue.resolveComponent("a-image-preview-group");

  return _vue.openBlock(), _vue.createBlock("div", _hoisted_1$5, [_vue.createVNode(_component_a_image_preview_group, null, {
    default: _withId$5(() => [_vue.renderSlot(_ctx.$slots, "default")]),
    _: 3
  })]);
});
...
var CheckCircleFilled$1 = CheckCircleFilled; // This icon file is generated automatically.
...
var CloseCircleFilled$1 = CloseCircleFilled; // This icon file is generated automatically.
...
var DeleteOutlined$1 = DeleteOutlined; // This icon file is generated automatically.
...
var LoadingOutlined$1 = LoadingOutlined; // This icon file is generated automatically.
...
var PlusOutlined$1 = PlusOutlined; // This icon file is generated automatically.

var ScissorOutlined$2 = {
  "icon": {
    "tag": "svg",
    "attrs": {
      "viewBox": "64 64 896 896",
...
var ScissorOutlinedSvg = ScissorOutlined$2;
...
var ScissorOutlined$1 = ScissorOutlined;

var script$4 = _vue.defineComponent({
  name: "previewItem",
  ...
  setup(props, {
    ...
    const invalidAspectRatio = _vue.computed(() => {
  ...
  components: {
    ...
    CheckCircleFilled: CheckCircleFilled$1,
    CloseCircleFilled: CloseCircleFilled$1,
    LoadingOutlined: LoadingOutlined$1
  }
});

const _withId$4 = /* @__PURE__ */_vue.withScopeId("data-v-37672004");

_vue.pushScopeId("data-v-37672004");
...
const render$4 = /* @__PURE__ */_withId$4((_ctx, _cache, $props, $setup, $data, $options) => {
  const _component_a_image = _vue.resolveComponent("a-image");

  const _component_CheckCircleFilled = _vue.resolveComponent("CheckCircleFilled");

  const _component_CloseCircleFilled = _vue.resolveComponent("CloseCircleFilled");

  const _component_a_checkbox = _vue.resolveComponent("a-checkbox");

  const _component_LoadingOutlined = _vue.resolveComponent("LoadingOutlined");

  const _component_ScissorOutlined = _vue.resolveComponent("ScissorOutlined");

  const _component_EASIButton = _vue.resolveComponent("EASIButton");

  const _component_DeleteOutlined = _vue.resolveComponent("DeleteOutlined");

  const _component_a_card = _vue.resolveComponent("a-card");

  return _vue.openBlock(), _vue.createBlock("div", _hoisted_1$4, [_vue.createVNode(_component_a_card, {
    bordered: "",
    hoverable: "",
    "body-style": {
      padding: 0
    ...
    cover: _withId$4(() => [_vue.createVNode("div", _hoisted_2$3, [_vue.createVNode(_component_a_image, {
      width: "100%",
      src: _ctx.item.url,
      class: {
        "easi-uploader-disabled-checked": (_ctx.disabled && !_ctx.item.checked || _ctx.invalidAspectRatio) && _ctx.activeKey === 1
      }
    }, null, 8, ["src", "class"]), _vue.createVNode("div", _hoisted_3$2, [_ctx.item.uploadSuccess && _ctx.activeKey === 0 ? (_vue.openBlock(), _vue.createBlock(_component_CheckCircleFilled, {
      key: 0,
      style: {
        "color": "#67c23a",
        "font-size": "18px"
      }
    })) : _vue.createCommentVNode("v-if", true), _ctx.item.uploadFail && _ctx.activeKey === 0 ? (_vue.openBlock(), _vue.createBlock(_component_CloseCircleFilled, {
      key: 1,
      style: {
        "color": "#ff4949",
        "font-size": "18px"
      }
    })) : _vue.createCommentVNode("v-if", true), _ctx.activeKey === 1 ? (_vue.openBlock(), _vue.createBlock(_component_a_checkbox, {
      key: 2,
    ...
    }, null, 8, ["checked", "disabled"])) : _vue.createCommentVNode("v-if", true)]), _vue.withDirectives(_vue.createVNode("span", _hoisted_4$2, [_vue.createVNode(_component_LoadingOutlined)], 512), [[_vue.vShow, !_ctx.item.uploadSuccess && _ctx.loading]])])]),
    default: _withId$4(() => [_ctx.activeKey === 0 ? (_vue.openBlock(), _vue.createBlock("ul", _hoisted_5$2, [_ctx.crop && !_ctx.item.uploadSuccess ? (_vue.openBlock(), _vue.createBlock("li", _hoisted_6$1, [_vue.createVNode(_component_EASIButton, {
      type: "link",
      block: "",
      ...
      key: "scissor",
      onClick: _cache[2] || (_cache[2] = _vue.withModifiers($event => _ctx.handleCrop(_ctx.item, _ctx.index), ["stop"]))
    }, {
      icon: _withId$4(() => [_vue.createVNode(_component_ScissorOutlined)]),
      _: 1
    }, 8, ["disabled"])])) : _vue.createCommentVNode("v-if", true), _vue.createVNode("li", {
      style: {
        width: _ctx.crop && !_ctx.item.uploadSuccess ? "50%" : "100%"
      }
    }, [_vue.createVNode(_component_EASIButton, {
      type: "link",
      block: "",
      disabled: _ctx.disabled || !_ctx.item.uploadSuccess && _ctx.loading,
      key: "delete",
      danger: "",
      onClick: _cache[3] || (_cache[3] = _vue.withModifiers($event => _ctx.handleDelete(_ctx.item, _ctx.index), ["stop"]))
    }, {
      icon: _withId$4(() => [_vue.createVNode(_component_DeleteOutlined)]),
      _: 1
    }, 8, ["disabled"])], 4)])) : _vue.createCommentVNode("v-if", true)]),
    _: 1
  })]);
});
...
const uploadProps = {
  ...
  env: {
    type: String,
    default: (_window = window) === null || _window === void 0 ? void 0 : _window.$EASI_BUILD_ENV
  }
};
...
var script$3 = _vue.defineComponent({
  name: "empty",
  emits: ["clickEmpty"],
  props: { ...emptyProps
  },
...
const _withId$3 = /* @__PURE__ */_vue.withScopeId("data-v-b0da4ce0");

_vue.pushScopeId("data-v-b0da4ce0");
...
const _hoisted_4$1 = /* @__PURE__ */_vue.createVNode("p", {
  class: "ant-upload-drag-icon"
}, [/* @__PURE__ */_vue.createVNode("span", {
  role: "img",
  "aria-label": "picture",
  class: "anticon anticon-picture"
}, [/* @__PURE__ */_vue.createVNode("svg", {
  focusable: "false",
  class: "",
  "data-icon": "picture",
  width: "1em",
  ...
  "aria-hidden": "true",
  viewBox: "64 64 896 896"
}, [/* @__PURE__ */_vue.createVNode("path", {
...
const render$3 = /* @__PURE__ */_withId$3((_ctx, _cache, $props, $setup, $data, $options) => {
  return _vue.openBlock(), _vue.createBlock("div", _hoisted_1$3, [_vue.createVNode("div", {
    class: "ant-upload ant-upload-drag",
    onClick: _cache[1] || (_cache[1] = _vue.withModifiers($event => _ctx.$emit("clickEmpty"), ["stop"]))
  }, [_vue.createVNode("div", _hoisted_2$2, [_vue.createVNode("div", _hoisted_3$1, [_hoisted_4$1, _vue.createVNode("p", _hoisted_5$1, _vue.toDisplayString(_ctx.emptyTitle || _ctx.getText("uploaderEmptyTitle")), 1), _vue.createVNode("p", _hoisted_6, _vue.toDisplayString(_ctx.emptySubTitle || _ctx.getText("uploaderEmptySubTitle")), 1)])])])]);
});
...
function useActionType(init = "") {
  const actionType = _vue.ref(init);
...
function fileToBlob(file) {
  return new Promise(resolve => {
    ...
    reader.onload = function (e) {
      ...
      resolve((_window2 = window) === null || _window2 === void 0 ? void 0 : _window2.URL.createObjectURL(blob));
    };
  });
}
      ...
      return new Promise(resolve => {
        canvas.toBlob(blob => {
          ...
          resolve({
            ...
            height,
            size: newFile.size,
            aspectRatio: parseFloat((canvas.width / canvas.height).toString()).toFixed(4),
            uploadSuccess: false,
            uploadFail: false,
            uploadLoading: false
          });
...
async function getEASIUploaderToken() {
  const oldToken = easiWebUtils.getCookie("easi-eut");
  ...
  if (oldToken) {
    ...
    if (data !== null && data !== void 0 && data.token) {
      easiWebUtils.setCookie("easi-eut", data === null || data === void 0 ? void 0 : data.token, 4 * 60 * 1e3);
    }
...
var script$2 = _vue.defineComponent({
  name: "localStore",
  ...
  setup(props, {
    ...
    const uploadGlobal = _vue.inject("uploadGlobal", {
      cropLoading: false,
      uploadLoading: false
    });
    ...
    const cropImageRef = _vue.ref();

    const cropperIndex = _vue.ref(-1);

    const cropperItem = _vue.ref();
    ...
    const toNext = async () => {
      ...
      setCurrent({ ..._vue.toRaw(array[index])
      }, index);
      initCrop();
    };
    ...
    const toPrev = () => {
      ...
      setCurrent({ ..._vue.toRaw(localUploadList.value[index])
      }, index);
      initCrop();
    };
    ...
    return {
      ...
      handleDelete(item, index) {
        emit("handleDelete", { ..._vue.toRaw(item)
        }, index);
      },

      handleCrop(item, index) {
        const pureItem = { ..._vue.toRaw(item)
        };
...
const _withId$2 = /* @__PURE__ */_vue.withScopeId("data-v-7e0ccd4e");

_vue.pushScopeId("data-v-7e0ccd4e");
...
const render$2 = /* @__PURE__ */_withId$2((_ctx, _cache, $props, $setup, $data, $options) => {
  const _component_Empty = _vue.resolveComponent("Empty");

  const _component_UploaderItem = _vue.resolveComponent("UploaderItem");

  const _component_PlusOutlined = _vue.resolveComponent("PlusOutlined");

  const _component_UploaderContainer = _vue.resolveComponent("UploaderContainer");

  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [_vue.createVNode("input", {
    ref: "inputRef",
    type: "file",
    accept: _ctx.accept,
  ...
  }, null, 40, ["accept", "multiple", "disabled"]), _vue.withDirectives(_vue.createVNode(_component_Empty, {
    emptyTitle: _ctx.emptyTitle,
    emptySubTitle: _ctx.emptySubTitle,
    onClickEmpty: _cache[2] || (_cache[2] = $event => _ctx.inputRef.click())
  }, null, 8, ["emptyTitle", "emptySubTitle"]), [[_vue.vShow, _ctx.localUploadList.length === 0 && _ctx.localUploadMustCrop.length === 0]]), _vue.withDirectives(_vue.createVNode(_component_UploaderContainer, null, {
    default: _withId$2(() => [(_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(_ctx.localUploadList, (item, index) => {
      return _vue.openBlock(), _vue.createBlock(_component_UploaderItem, {
        key: index,
        item,
        index,
        crop: _ctx.crop,
    ...
    }), 128)), _vue.withDirectives(_vue.createVNode("div", {
      class: "easi-uploader-add-btn",
      onClick: _cache[3] || (_cache[3] = $event => _ctx.inputRef.click())
    }, [_vue.createVNode("div", _hoisted_1$2, [_vue.createVNode("p", null, [_vue.createVNode(_component_PlusOutlined)]), _vue.createVNode("p", _hoisted_2$1, _vue.toDisplayString(_ctx.localUploadList.length) + " / " + _vue.toDisplayString(_ctx.multiple), 1)])], 512), [[_vue.vShow, _ctx.showAddBtn]])]),
    _: 1
  }, 512), [[_vue.vShow, !_ctx.isCropping && _ctx.localUploadList.length > 0]]), _vue.withDirectives(_vue.createVNode("div", _hoisted_3, [_vue.createVNode("div", _hoisted_4, [_vue.createVNode("img", _hoisted_5, null, 512)])], 512), [[_vue.vShow, _ctx.isCropping]])], 64);
});
...
var script$1 = _vue.defineComponent({
  name: "imageStore",
  ...
  setup(props, {
    ...
    const imageList = _vue.ref([]);

    const current = _vue.ref(1);

    const total = _vue.ref(0);

    let pageSize = _vue.ref(20);
    ...
    const getImageList = async _filename => {
      ...
      try {
        ...
        antDesignVue.message.error(getText.value("uploadListError"));
        emit("error", e);
      }
...
const _withId$1 = /* @__PURE__ */_vue.withScopeId("data-v-704c7293");

_vue.pushScopeId("data-v-704c7293");
...
const render$1 = /* @__PURE__ */_withId$1((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  const _component_a_empty = _vue.resolveComponent("a-empty");

  const _component_a_pagination = _vue.resolveComponent("a-pagination");

  const _component_UploaderContainer = _vue.resolveComponent("UploaderContainer");

  const _directive_loading = _vue.resolveDirective("loading");

  return _vue.withDirectives((_vue.openBlock(), _vue.createBlock(_component_UploaderContainer, null, {
    default: _withId$1(() => [_vue.createVNode("div", _hoisted_1$1, [(_vue.openBlock(true), _vue.createBlock(_vue.Fragment, null, _vue.renderList(_ctx.imageList, (item, index) => {
      return _vue.openBlock(), _vue.createBlock(_component_UploaderItem, {
        key: index,
        item,
        index,
    ...
    }), 128)), _vue.withDirectives(_vue.createVNode(_component_a_empty, {
      image: _ctx.simpleImage
    }, null, 8, ["image"]), [[_vue.vShow, _ctx.imageList.length === 0]])]), _vue.withDirectives(_vue.createVNode("div", _hoisted_2, [_vue.createVNode(_component_a_pagination, {
      "show-quick-jumper": "",
      "show-size-changer": "",
    ...
    }, null, 8, ["show-total", "current", "page-size", "total", "onChange", "onShowSizeChange"])], 512), [[_vue.vShow, _ctx.total > 0 && _ctx.imageList.length > 0]])]),
    _: 1
...
var script = _vue.defineComponent({
  ...
  setup(props, {
    ...
    const symbolVisible = _vue.ref(false);

    const domain = _vue.computed(() => {
      return env.value === "production" ? "https://oss.easiglobal.com" : "https://oss.melbdelivery.com";
    });

    const activeKey = _vue.ref(0);

    const app = _vue.getCurrentInstance();

    const uploadGlobal = _vue.reactive({
      cropLoading: false,
      uploadLoading: false,
      listLoading: false
    });

    const cropIndex = _vue.ref(0);

    _vue.provide("uploadGlobal", uploadGlobal);
    ...
    const uploadRef = _vue.ref();

    const imageStoreRef = _vue.ref();

    const localUploadList = _vue.ref([]);

    const localUploadLoading = _vue.ref(false);

    const localUploadMustCrop = _vue.ref([]);

    const waitToUpload = _vue.computed(() => {
      return localUploadList.value.filter(item => !item.uploadSuccess);
    });

    const alreadyUpload = _vue.computed(() => {
      return localUploadList.value.filter(item => item.uploadSuccess);
    });

    const checkedList = _vue.ref([]);

    const isCropping = _vue.ref(false);
      ...
      if (localUploadMustCrop.value.length > 0) {
        ...
        if (isCropping.value) {
          if (localUploadMustCrop.value.length === 0) {
            ...
            uploadRef.value.setCurrent({ ..._vue.toRaw(localUploadMustCrop.value[realIndex])
            }, realIndex);
        ...
        if (isCropping.value) {
          if (localUploadList.value.length === 0) {
            ...
            let realIndex = index > len ? len : index;
            cropIndex.value = realIndex;
            uploadRef.value.setCurrent({ ..._vue.toRaw(localUploadList.value[realIndex])
            }, realIndex);
            uploadRef.value.initCrop();
          }
        }
    ...
    const handleUpload = async () => {
      ...
      for (let i = 0; i < localUploadList.value.length; i++) {
        ...
        try {
          ...
          const newItem = await uploadPic({ ..._vue.toRaw(localUploadList.value[i])
          }, options);
          localUploadList.value.splice(i, 1, newItem);
        } catch (e) {
          antDesignVue.message.error(getText("uploadError"));
    ...
    const handleOK = () => {
      if (activeKey.value === 0) {
        ...
        if (waitToUpload.value.length > 0) {
          return antDesignVue.Modal.confirm({
    ...
    const handleCheckedChange = (checked, item, index) => {
      if (checked) {
        checkedList.value.push({ ..._vue.toRaw(item)
        });
      } else {
    ...
    return {
      ...
      async handleChange(e, fromAction = "") {
        ...
        if (fromAction === "drop" && extType.value && fileList.some(file => {
          ...
          antDesignVue.message.error(errorMsg);
          return emit("error", {
        ...
        for (const file of fileList) {
          try {
            ...
            localUploadLoading.value = false;
            antDesignVue.message.error(e2.message);
            return emit("error", e2);
          }
        }

        localUploadLoading.value = false;
        localUploadList.value = [..._vue.toRaw(localUploadList.value), ...fileArray];
        localUploadMustCrop.value = [..._vue.toRaw(localUploadMustCrop.value), ...mustCropArray];

        if (localUploadMustCrop.value.length > 0) {
          isCropping.value = true;
          cropIndex.value = 0;
          uploadRef.value.setCurrent({ ..._vue.toRaw(localUploadMustCrop.value[0])
          }, 0);
          uploadRef.value.initCrop();
        }
...
const _withId = /* @__PURE__ */_vue.withScopeId("data-v-67d79ad6");

_vue.pushScopeId("data-v-67d79ad6");
...
const render = /* @__PURE__ */_withId((_ctx, _cache, $props, $setup, $data, $options) => {
  const _component_Upload = _vue.resolveComponent("Upload");

  const _component_a_tab_pane = _vue.resolveComponent("a-tab-pane");

  const _component_ImageStore = _vue.resolveComponent("ImageStore");

  const _component_a_input_search = _vue.resolveComponent("a-input-search");

  const _component_a_form_item = _vue.resolveComponent("a-form-item");

  const _component_EASIButton = _vue.resolveComponent("EASIButton");

  const _component_a_form = _vue.resolveComponent("a-form");

  const _component_a_tabs = _vue.resolveComponent("a-tabs");

  const _component_a_typography_text = _vue.resolveComponent("a-typography-text");

  const _component_a_space = _vue.resolveComponent("a-space");

  const _component_EASIModal = _vue.resolveComponent("EASIModal");

  const _directive_loading = _vue.resolveDirective("loading");

  return _vue.openBlock(), _vue.createBlock(_vue.Fragment, null, [_vue.renderSlot(_ctx.$slots, "default"), _vue.createVNode(_component_EASIModal, {
    ...
    footer: _withId(() => [_vue.createVNode("div", _hoisted_1, [_vue.withDirectives(_vue.createVNode(_component_a_typography_text, {
      type: "secondary",
      class: "flex-1 text-left"
    }, {
      default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("selected")) + " " + _vue.toDisplayString(_ctx.checkedList.length) + " / " + _vue.toDisplayString(typeof _ctx.multiple === "number" ? _ctx.multiple : 1), 1)]),
      _: 1
    }, 512), [[_vue.vShow, _ctx.activeKey === 1]]), _ctx.localUploadList.length === 0 && _ctx.localUploadMustCrop.length === 0 && _ctx.multiple !== true && _ctx.activeKey === 0 ? (_vue.openBlock(), _vue.createBlock(_component_a_typography_text, {
      key: 0,
      type: "secondary",
      class: "flex-1 text-left"
    }, {
      default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("uploaderError1", {
        max: typeof _ctx.multiple === "number" ? _ctx.multiple.toString() : 1
      })), 1)]),
      _: 1
    })) : _vue.createCommentVNode("v-if", true), _ctx.localUploadMustCrop.length > 0 ? (_vue.openBlock(), _vue.createBlock(_component_a_typography_text, {
      key: 1,
      type: "danger",
      class: "flex-1 text-left"
    }, {
      default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("uploaderMustCropTips", {
        number: _ctx.localUploadMustCrop.length
      })), 1)]),
      _: 1
    })) : _vue.createCommentVNode("v-if", true), _vue.createVNode(_component_a_space, null, {
      default: _withId(() => [_vue.createCommentVNode(" \u5173\u95ED\u5F39\u6846\u6309\u94AE "), !_ctx.isCropping ? (_vue.openBlock(), _vue.createBlock(_component_EASIButton, {
        key: 0,
        disabled: _ctx.disabled,
        onClick: _ctx.handleCancel
      }, {
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("cancel")), 1)]),
        _: 1
      }, 8, ["disabled", "onClick"])) : _vue.createCommentVNode("v-if", true), _vue.createCommentVNode(" \u5F00\u59CB\u4E0A\u4F20\u6309\u94AE "), _ctx.activeKey === 0 && !_ctx.isCropping && _ctx.waitToUpload.length > 0 ? (_vue.openBlock(), _vue.createBlock(_component_EASIButton, {
        key: 1,
        type: "primary",
        disabled: _ctx.disabled,
        loading: _ctx.uploadGlobal.uploadLoading,
        success: "",
        onClick: _vue.withModifiers(_ctx.handleUpload, ["stop"])
      }, {
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("uploaderPrimary")), 1)]),
        _: 1
      }, 8, ["disabled", "loading", "onClick"])) : _vue.createCommentVNode("v-if", true), _vue.createCommentVNode(" \u786E\u8BA4\u9009\u62E9\u6309\u94AE "), _ctx.activeKey === 1 || _ctx.activeKey === 0 && !_ctx.isCropping && _ctx.alreadyUpload.length > 0 ? (_vue.openBlock(), _vue.createBlock(_component_EASIButton, {
        key: 2,
        type: "primary",
        disabled: _ctx.disabled,
        onClick: _vue.withModifiers(_ctx.handleOK, ["stop"])
      }, {
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("confirm")), 1)]),
        _: 1
      }, 8, ["disabled", "onClick"])) : _vue.createCommentVNode("v-if", true), _vue.createCommentVNode(" \u88C1\u526A\u8FC7\u7A0B\u4E2D\u8FD4\u56DE\u56FE\u7247\u5217\u8868\u754C\u9762 "), _ctx.isCropping ? (_vue.openBlock(), _vue.createBlock(_component_EASIButton, {
        key: 3,
        disabled: _ctx.disabled,
        onClick: _vue.withModifiers(_ctx.handleCropBack, ["stop"])
      }, {
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("uploadBack")), 1)]),
        _: 1
      }, 8, ["disabled", "onClick"])) : _vue.createCommentVNode("v-if", true), _vue.createCommentVNode(" \u88C1\u526A\u8FC7\u7A0B\u4E2D\u5220\u9664\u67D0\u5F20\u56FE\u7247 "), _ctx.activeKey === 0 && _ctx.isCropping ? (_vue.openBlock(), _vue.createBlock(_component_EASIButton, {
        key: 4,
        type: "primary",
        danger: "",
        disabled: _ctx.disabled,
        onClick: _cache[12] || (_cache[12] = _vue.withModifiers($event => _ctx.handleDelete(null, _ctx.cropIndex), ["stop"]))
      }, {
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("uploaderRemove")), 1)]),
        _: 1
      }, 8, ["disabled"])) : _vue.createCommentVNode("v-if", true), _vue.createCommentVNode(" \u4E0A\u4E00\u5F20 "), _ctx.activeKey === 0 && _ctx.isCropping && _ctx.localUploadMustCrop.length === 0 && _ctx.localUploadList.length > 1 ? (_vue.openBlock(), _vue.createBlock(_component_EASIButton, {
        key: 5,
        type: "primary",
        disabled: _ctx.disabled,
        onClick: _vue.withModifiers(_ctx.handleToPrev, ["stop"])
      }, {
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("uploaderPrev")), 1)]),
        _: 1
      }, 8, ["disabled", "onClick"])) : _vue.createCommentVNode("v-if", true), _vue.createCommentVNode(" \u4E0B\u4E00\u5F20 "), _ctx.activeKey === 0 && _ctx.isCropping && (_ctx.localUploadMustCrop.length > 1 || _ctx.localUploadMustCrop.length === 0 && _ctx.localUploadList.length > 1) ? (_vue.openBlock(), _vue.createBlock(_component_EASIButton, {
        key: 6,
        type: "primary",
        disabled: _ctx.disabled,
        onClick: _vue.withModifiers(_ctx.handleToNext, ["stop"]),
        loading: _ctx.uploadGlobal.cropLoading,
        success: _ctx.localUploadMustCrop.length > 1
      }, {
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.localUploadMustCrop.length > 0 ? _ctx.getText("uploaderConfirmNext") : _ctx.getText("uploaderNext")), 1)]),
        _: 1
      }, 8, ["disabled", "onClick", "loading", "success"])) : _vue.createCommentVNode("v-if", true), _vue.createCommentVNode(" \u786E\u8BA4\u88C1\u526A\u6309\u94AE "), _ctx.activeKey === 0 && _ctx.isCropping && _ctx.localUploadMustCrop.length <= 1 ? (_vue.openBlock(), _vue.createBlock(_component_EASIButton, {
        key: 7,
        type: "primary",
        success: "",
        loading: _ctx.uploadGlobal.cropLoading,
        disabled: _ctx.disabled,
        onClick: _vue.withModifiers(_ctx.handleToCrop, ["stop"])
      }, {
        default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("uploaderConfirmCrop")), 1)]),
        _: 1
      }, 8, ["loading", "disabled", "onClick"])) : _vue.createCommentVNode("v-if", true)]),
      _: 1
    })])]),
    default: _withId(() => [_vue.createVNode(_component_a_tabs, {
      type: "card",
      activeKey: _ctx.activeKey,
      "onUpdate:activeKey": _cache[11] || (_cache[11] = $event => _ctx.activeKey = $event)
    }, {
      tabBarExtraContent: _withId(() => [_vue.withDirectives(_vue.createVNode(_component_a_form, {
        layout: "inline"
      }, {
        default: _withId(() => [_vue.createVNode(_component_a_form_item, null, {
          default: _withId(() => [_vue.createVNode(_component_a_input_search, {
            value: _ctx.search,
          ...
          _: 1
        }), _vue.createVNode(_component_a_form_item, null, {
          default: _withId(() => [_vue.createVNode(_component_EASIButton, {
            type: "primary",
            loading: _ctx.uploadGlobal.listLoading,
            onClick: _vue.withModifiers(_ctx.handleSearch, ["stop"])
          }, {
            default: _withId(() => [_vue.createTextVNode(_vue.toDisplayString(_ctx.getText("search")), 1)]),
            _: 1
          }, 8, ["loading", "onClick"])]),
          _: 1
        })]),
        _: 1
      }, 512), [[_vue.vShow, _ctx.activeKey === 1]])]),
      default: _withId(() => [_vue.withDirectives(_vue.createVNode(_component_a_tab_pane, {
        class: ["pane-container", _ctx.actionType],
        key: 0,
        tab: _ctx.getText("uploaderTab0"),
        onDragover: _cache[1] || (_cache[1] = _vue.withModifiers($event => _ctx.setActionType("dragover"), ["prevent"])),
        onDragleave: _cache[2] || (_cache[2] = _vue.withModifiers($event => _ctx.setActionType(""), ["prevent"])),
        onDragend: _cache[3] || (_cache[3] = _vue.withModifiers(() => {}, ["prevent"])),
        onDrop: _cache[4] || (_cache[4] = _vue.withModifiers($event => _ctx.handleChange($event, "drop"), ["prevent"]))
      }, {
        default: _withId(() => [_vue.createVNode(_component_Upload, {
          ref: "uploadRef",
        ...
        _: 1
      }, 8, ["class", "tab"]), [[_directive_loading, _ctx.localUploadLoading]]), _vue.createVNode(_component_a_tab_pane, {
        class: ["pane-container relative overflow-hidden", _ctx.actionType],
        key: 1,
        tab: _ctx.getText("uploaderTab1"),
        onDragover: _cache[6] || (_cache[6] = _vue.withModifiers($event => _ctx.setActionType("dragover"), ["prevent"])),
        onDragleave: _cache[7] || (_cache[7] = _vue.withModifiers($event => _ctx.setActionType(""), ["prevent"])),
        onDragend: _cache[8] || (_cache[8] = _vue.withModifiers(() => {}, ["prevent"])),
        onDrop: _cache[9] || (_cache[9] = _vue.withModifiers($event => _ctx.handleChange($event, "drop"), ["prevent"]))
      }, {
        default: _withId(() => [_vue.createVNode(_component_ImageStore, {
          ref: "imageStoreRef",
