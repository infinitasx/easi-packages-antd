...
import { toRaw, h, nextTick, defineComponent, toRefs, inject, watch, createVNode, pushScopeId, popScopeId, resolveComponent, openBlock, createBlock, mergeProps, withCtx, createElementVNode, createCommentVNode, createTextVNode, toDisplayString, renderSlot, createElementBlock, Fragment, renderList } from 'vue';
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_a_drawer, mergeProps({
    ...
    title: withCtx(() => {
      ...
      return [createElementVNode("header", _hoisted_1, [(_ctx$userInfo = _ctx.userInfo) !== null && _ctx$userInfo !== void 0 && _ctx$userInfo.avatar ? (openBlock(), createBlock(_component_a_avatar, {
        key: 0,
        shape: "circle",
        size: "default",
    ...
    default: withCtx(() => {
      ...
      return [renderSlot(_ctx.$slots, "action-render"), ((_ctx$userInfo3 = _ctx.userInfo) === null || _ctx$userInfo3 === void 0 ? void 0 : (_ctx$userInfo3$device = _ctx$userInfo3.devices) === null || _ctx$userInfo3$device === void 0 ? void 0 : _ctx$userInfo3$device.length) > 0 ? (openBlock(), createElementBlock(Fragment, {
        ...
        return openBlock(), createElementBlock("div", {
          class: "mb-32",
          key: item.id
        }, [createElementVNode("p", _hoisted_2, [createVNode(_component_a_typography_text, {
          type: "secondary"
        }, {
