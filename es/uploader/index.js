...
import { defineComponent, pushScopeId, popScopeId, resolveComponent, openBlock, createElementBlock, createVNode, withCtx, renderSlot, h, nextTick, toRefs, computed, createElementVNode, normalizeClass, createBlock, createCommentVNode, withDirectives, vShow, withModifiers, normalizeStyle, inject, toDisplayString, ref, onBeforeUnmount, toRaw, Fragment, renderList, resolveDirective, getCurrentInstance, reactive, provide, onMounted, createTextVNode } from 'vue';
...
function render$5(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$5, [createVNode(_component_a_image_preview_group, null, {
...
function render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$4, [createVNode(_component_a_card, {
    bordered: "",
    hoverable: "",
    "body-style": {
      padding: 0
    ...
    cover: withCtx(() => [createElementVNode("div", _hoisted_2$3, [createVNode(_component_a_image, {
      width: "100%",
      src: _ctx.item.url,
      class: normalizeClass({
        "easi-uploader-disabled-checked": (_ctx.disabled && !_ctx.item.checked || _ctx.invalidAspectRatio) && _ctx.activeKey === 1
      })
    }, null, 8, ["src", "class"]), createElementVNode("div", _hoisted_3$2, [_ctx.item.uploadSuccess && _ctx.activeKey === 0 ? (openBlock(), createBlock(_component_CheckCircleFilled, {
      key: 0,
      style: {
        "color": "#67c23a",
        "font-size": "18px"
    ...
    }, null, 8, ["checked", "disabled"])) : createCommentVNode("v-if", true)]), withDirectives(createElementVNode("span", _hoisted_4$2, [createVNode(_component_LoadingOutlined)], 512), [[vShow, !_ctx.item.uploadSuccess && _ctx.loading]])])]),
    default: withCtx(() => [_ctx.activeKey === 0 ? (openBlock(), createElementBlock("ul", _hoisted_5$2, [_ctx.crop && !_ctx.item.uploadSuccess ? (openBlock(), createElementBlock("li", _hoisted_6$1, [createVNode(_component_EASIButton, {
      type: "link",
      block: "",
      ...
      key: "scissor",
      onClick: _cache[1] || (_cache[1] = withModifiers($event => _ctx.handleCrop(_ctx.item, _ctx.index), ["stop"]))
    }, {
      icon: withCtx(() => [createVNode(_component_ScissorOutlined)]),
      _: 1
    }, 8, ["disabled"])])) : createCommentVNode("v-if", true), createElementVNode("li", {
      ...
      key: "delete",
      danger: "",
      onClick: _cache[2] || (_cache[2] = withModifiers($event => _ctx.handleDelete(_ctx.item, _ctx.index), ["stop"]))
    }, {
...
const _hoisted_4$1 = /* @__PURE__ */createElementVNode("p", {
...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$3, [createElementVNode("div", {
    ...
    onClick: _cache[0] || (_cache[0] = withModifiers($event => _ctx.$emit("clickEmpty"), ["stop"]))
  }, [createElementVNode("div", _hoisted_2$2, [createElementVNode("div", _hoisted_3$1, [_hoisted_4$1, createElementVNode("p", _hoisted_5$1, toDisplayString(_ctx.emptyTitle || _ctx.getText("uploaderEmptyTitle")), 1), createElementVNode("p", _hoisted_6, toDisplayString(_ctx.emptySubTitle || _ctx.getText("uploaderEmptySubTitle")), 1)])])])]);
}
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [createElementVNode("input", {
  ...
  }, null, 40, _hoisted_1$2), withDirectives(createVNode(_component_Empty, {
    ...
    default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.localUploadList, (item, index) => {
    ...
    }), 128)), withDirectives(createElementVNode("div", {
      class: "easi-uploader-add-btn",
      onClick: _cache[2] || (_cache[2] = $event => _ctx.inputRef.click())
    }, [createElementVNode("div", _hoisted_2$1, [createElementVNode("p", null, [createVNode(_component_PlusOutlined)]), createElementVNode("p", _hoisted_3, toDisplayString(_ctx.localUploadList.length) + " / " + toDisplayString(_ctx.multiple), 1)])], 512), [[vShow, _ctx.showAddBtn]])]),
    _: 1
  }, 512), [[vShow, !_ctx.isCropping]]), withDirectives(createElementVNode("div", _hoisted_4, [createElementVNode("img", _hoisted_5, null, 512)], 512), [[vShow, _ctx.isCropping]])], 64);
}
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createBlock(_component_UploaderContainer, null, {
    default: withCtx(() => [createElementVNode("div", _hoisted_1$1, [(openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.imageList, (item, index) => {
      return openBlock(), createBlock(_component_UploaderItem, {
        key: index,
        item,
        index,
    ...
    }), 128))]), withDirectives(createElementVNode("div", _hoisted_2, [createVNode(_component_a_pagination, {
      "show-quick-jumper": "",
      "show-size-changer": "",
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [renderSlot(_ctx.$slots, "default"), createVNode(_component_EASIModal, {
    ...
    footer: withCtx(() => [createElementVNode("div", _hoisted_1, [withDirectives(createVNode(_component_a_typography_text, {
      type: "secondary",
      ...
      default: withCtx(() => [createCommentVNode(" \u5173\u95ED\u5F39\u6846\u6309\u94AE "), !_ctx.isCropping ? (openBlock(), createBlock(_component_EASIButton, {
        ...
        danger: "",
        disabled: _ctx.disabled,
        onClick: _cache[11] || (_cache[11] = withModifiers($event => _ctx.handleDelete(null, _ctx.cropIndex), ["stop"]))
      }, {
    ...
    default: withCtx(() => [createVNode(_component_a_tabs, {
      ...
      default: withCtx(() => [withDirectives(createVNode(_component_a_tab_pane, {
        class: normalizeClass(["pane-container", _ctx.actionType]),
        key: 0,
        tab: _ctx.getText("uploaderTab0"),
        onDragover: _cache[0] || (_cache[0] = withModifiers($event => _ctx.setActionType("dragover"), ["prevent"])),
        onDragleave: _cache[1] || (_cache[1] = withModifiers($event => _ctx.setActionType(""), ["prevent"])),
        onDragend: _cache[2] || (_cache[2] = withModifiers(() => {}, ["prevent"])),
        onDrop: _cache[3] || (_cache[3] = withModifiers($event => _ctx.handleChange($event, "drop"), ["prevent"]))
      }, {
        ...
        onDragover: _cache[5] || (_cache[5] = withModifiers($event => _ctx.setActionType("dragover"), ["prevent"])),
        onDragleave: _cache[6] || (_cache[6] = withModifiers($event => _ctx.setActionType(""), ["prevent"])),
        onDragend: _cache[7] || (_cache[7] = withModifiers(() => {}, ["prevent"])),
        onDrop: _cache[8] || (_cache[8] = withModifiers($event => _ctx.handleChange($event, "drop"), ["prevent"]))
      }, {
