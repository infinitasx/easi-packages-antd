...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return withDirectives((openBlock(), createBlock(_component_a_table, mergeProps({
    scroll: _ctx.scroll
    ...
    fn: withCtx(() => [createVNode(_component_a_row, {
      ...
      default: withCtx(() => [createVNode(_component_a_col, {
        ...
        default: withCtx(() => [_ctx.$slots.headerLeft ? (openBlock(), createBlock(_component_a_space, {
          key: 0,
          class: "flex-wrap"
        }, {
