...
onMounted(()=>{
  var typed = new Typed(dom.value, {
    strings: ["npm install https://github.com/infinitasx/easi-packages-antd.git", "yarn add https://github.com/infinitasx/easi-packages-antd.git"],
    typeSpeed: 30,
    loop: true,
    backDelay:2000
  });
...
<section>
  ...
  <div class="fixed top-72 sm:top-96 left-1/2 max-w-full transform -translate-x-1/2 flex justify-center flex-col items-center">
    <h3 class="m-0 md:text-72 font-extralight tracking-widest font-sans text-42 sm:text-52">EASI PACKAGES ANTD</h3>
